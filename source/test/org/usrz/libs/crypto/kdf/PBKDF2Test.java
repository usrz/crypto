...
public class PBKDF2Test {
    ...
    public void testSHA1() {
        ...
        Assert.assertEquals(result, BASE_64.decode("AU2JLf2rNxWoZxWxRCluY0u6h6c"));
    }
    ...
    public void testSHA256_1() {
        ...
        Assert.assertEquals(result, BASE_64.decode("Y11AchqV4b0sUisdZd0Xr97KWoymNE0LNNrnEgY4H9M"));
    }
    ...
    public void testSHA256_2() {
        ...
        Assert.assertEquals(result, BASE_64.decode("tRRlz8hYn63B9LYiCd6PRo6FMiunY9ozmMMI3srxeRE"));
    }
    ...
    public void testSHA256_3() {
        ...
        byte[] result = new PBKDF2(Hash.SHA256, 6400).deriveKey(password, salt);
        Assert.assertEquals(result, BASE_64.decode("98jZicV16ODfEsEZeYPGHU3kbrUrvUEXOPimVSQDD44"));
    }
